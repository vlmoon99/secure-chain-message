 ...
 * @returns {string}
 */
export function encrypt_message(public_key_pem, message) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function decrypt_message(private_key_pem, encrypted_message_base64) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(private_key_pem, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(encrypted_message_base64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
...
export class KeyPair {
    ...
    set public_key(arg0) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_keypair_public_key(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {string}
     */
    ...
    set private_key(arg0) {
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_keypair_private_key(this.__wbg_ptr, ptr0, len0);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('cryptography_project_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
